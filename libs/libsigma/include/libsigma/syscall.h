...
#define SIGMA_SYSCALL_VM_MAP          3
#define SIGMA_SYSCALL_READ_INITRD     4
#define SIGMA_SYSCALL_INITRD_SIZE     5
#define SIGMA_SYSCALL_IPC_SEND        6
#define SIGMA_SYSCALL_IPC_RECEIVE     7
#define SIGMA_SYSCALL_IPC_GET_SIZE    8
#define SIGMA_SYSCALL_GET_UM_TID      9
#define SIGMA_SYSCALL_BLOCK_THREAD    10
